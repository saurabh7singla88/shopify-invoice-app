/**
 * API Route: GSTR-1 B2C (Others) Report
 * Returns aggregated B2C sales data grouped by Place of Supply and Tax Rate
 */

import type { LoaderFunctionArgs } from "react-router";
import { authenticate } from "../shopify.server";
import { generateB2CReport } from "../services/gstReporting.server";
...
export async function loader({ request }: LoaderFunctionArgs) {
  ...
  try {
    const report = await generateB2CReport(shop, finalStartDate, finalEndDate);
    ...
    console.error("Error generating B2C report:", error);
    return Response.json(
